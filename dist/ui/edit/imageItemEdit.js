    ...
    constructor() {
        ...
        */
        this.upload = () => __awaiter(this, void 0, void 0, function* () {
            if (!this.resUploader)
                return;
            this.resId = yield this.resUploader.upload();
            ...
            return React.createElement(Page, { header: '更改' + this.label, right: right },
                React.createElement("div", { className: "my-3 px-3 py-3 bg-white" },
                    React.createElement("div", null,
                        "\u4E0A\u4F20\u56FE\u7247\uFF1A",
                        React.createElement(ResUploader, { ref: v => this.resUploader = v }),
                    ...
                    React.createElement("div", { className: "d-flex" },
                        React.createElement("div", { className: "mr-5", style: { border: '1px dotted gray', padding: '8px' } },
                            React.createElement(Image, { className: "w-12c h-12c", src: this.resId })),
